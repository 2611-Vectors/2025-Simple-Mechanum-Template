...
public class SparkFlexDrivetrain extends SubsystemBase {
  private final SparkFlex frontLeft, frontRight, backLeft, backRight;

  private final PIDController turnPID;
  private double rotationOffset = 0.0;

  /** Creates a new Drive. */
  public SparkFlexDrivetrain() {
    frontLeft = new SparkFlex(FRONT_LEFT_MOTOR_ID, MOTOR_TYPE);
    frontRight = new SparkFlex(FRONT_RIGHT_MOTOR_ID, MOTOR_TYPE);
    backLeft = new SparkFlex(BACK_LEFT_MOTOR_ID, MOTOR_TYPE);
    backRight = new SparkFlex(BACK_RIGHT_MOTOR_ID, MOTOR_TYPE);
