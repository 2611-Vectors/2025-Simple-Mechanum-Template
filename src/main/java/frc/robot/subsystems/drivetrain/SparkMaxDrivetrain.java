...
public class SparkMaxDrivetrain extends SubsystemBase {
  ...
  public SparkMaxDrivetrain() {
    frontLeft = new SparkMax(FRONT_LEFT_MOTOR_ID, MOTOR_TYPE);
    frontRight = new SparkMax(FRONT_RIGHT_MOTOR_ID, MOTOR_TYPE);
    backLeft = new SparkMax(BACK_LEFT_MOTOR_ID, MOTOR_TYPE);
    backRight = new SparkMax(BACK_RIGHT_MOTOR_ID, MOTOR_TYPE);
